...
$mail->Port     = 587;
// Sender info 
$mail->setFrom('info@hidhanipackers.com', 'DBS Cargo Movers'); 
$mail->addReplyTo('info@hidhanipackers.com', 'Test Email'); 
 
// Add a recipient 
$mail->addAddress('hidhanipackers@gmail.com'); 
...
if(!$mail->send()){ ?>
    ...
    window.location.href="http://hidhanipackers.com/index.html";
    </script>
    // 
    <?php
